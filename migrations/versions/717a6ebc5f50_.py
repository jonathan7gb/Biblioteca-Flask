...
def upgrade():
    ...
    sa.Column('statusEmprestimo', sa.String(length=100), nullable=True),
    sa.ForeignKeyConstraint(['livro_id'], ['livro.id'], name='fk_emprestimo_livro'),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name='fk_emprestimo_user'),
    sa.PrimaryKeyConstraint('id')
    )
